...
%   update parameters using current inputs ant current error
    ...
    w1 = w1 + l_grade * e1 * x1(1);
    w2 = w2 + l_grade * e1 * x1(1);
    b = b + l_grade * e1;
...
%   update parameters using current inputs ant current error
    ...
    w1 = w1 + l_grade * e2 * x1(2);
    w2 = w2 + l_grade * e2 * x1(2);
    b = b + l_grade * e2;
...
%   update parameters using current inputs ant current error
    ...
    w1 = w1 + l_grade * e3 * x1(3);
    w2 = w2 + l_grade * e3 * x1(3);
    b = b + l_grade * e3;
%   Test how good are updated parameters (weights) on all examples used for training
%   calculate outputs and errors for all 5 examples using current values of the parameter set {w1, w2, b}
%   calculate 'v1', 'v2', 'v3',... 'v5'
...
%   update parameters using current inputs ant current error
    ...
    w1 = w1 + l_grade * e4 * x1(4);
    w2 = w2 + l_grade * e4 * x1(4);
    b = b + l_grade * e4;
...
%   update parameters using current inputs ant current error
    ...
    w1 = w1 + l_grade * e5 * x1(5);
    w2 = w2 + l_grade * e5 * x1(5);
    b = b + l_grade * e5;
...
%Testing on other available values
